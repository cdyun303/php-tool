 ...
 * @date 2026/2/23 18:44
 */

use Cdyun\PhpTool\Arr;
use Cdyun\PhpTool\Crypto;
use Cdyun\PhpTool\Curl;
use Cdyun\PhpTool\Generate;
use Cdyun\PhpTool\Geo;
use Cdyun\PhpTool\Ip;
use Cdyun\PhpTool\Str;
use Cdyun\PhpTool\Time;
...
if (!function_exists('str_to_camel')) {
     ...
     * @return array|string 驼峰命名
     */
    function str_to_camel(array|string $data): array|string
    {
        return Str::toCamel($data);
    }
}
...
if (!function_exists('str_to_snake')) {
    /**
     * 驼峰命名转下划线命名(支持数组键名)
     * @param array|string $data - 字符串或数组
     * @return array|string 下划线命名
     */
    function str_to_snake(array|string $data): array|string
    {
        return Str::toSnake($data);
    }
}
...
if (!function_exists('curl_get')) {
     ...
     * @return array
     */
    function curl_get(string $url, array $query = [], array $headers = [], array $options = []): array
    {
        return Curl::get($url, $query,$headers,$options);
    }
}
...
if (!function_exists('curl_post')) {
     ...
     * @return array 响应对象
     */
    function curl_post(string $url, array $query = [], array $headers = [], array $options = []): array
    {
        return Curl::post($url, $query,$headers,$options);
    }
}
...
if (!function_exists('curl_put')) {
     ...
     * @return array 响应对象
     */
    function curl_put(string $url, array $query = [], array $headers = [], array $options = []): array
    {
        return Curl::put($url, $query,$headers,$options);
    }
}
...
if (!function_exists('curl_patch')) {
     ...
     * @return array 响应对象
     */
    function curl_patch(string $url, array $query = [], array $headers = [], array $options = []): array
    {
        return Curl::patch($url, $query,$headers,$options);
    }
}
...
if (!function_exists('curl_delete')) {
     ...
     * @return array 响应对象
     */
    function curl_delete(string $url, array $query = [], array $headers = [], array $options = []): array
    {
        return Curl::delete($url, $query,$headers,$options);
    }
}
...
if (!function_exists('curl_request')) {
     ...
     * @return array 响应对象
     */
    function curl_request(string $method, string $url, array $options = []): array
    {
        return Curl::request($method, $url,$options);
    }
}
