...
class Math
{
     ...
     * @param int $scale 保留小数位数
     * @return float|string 百分比值
     */
    public static function percentage(float|int|string $part, float|int|string $total, int $scale = 2): float|string
    {
        if ($total == 0) {
     ...
     * @param int $scale 保留小数位数
     * @return float|string 折后价格
     */
    public static function discount(float|int|string $price, float|int|string $discount, int $scale = 2): float|string
    {
     ...
     * @param int $scale 保留小数位数
     * @return float|string 税费
     */
    public static function tax(float|int|string $amount, float|int|string $rate, int $scale = 2): float|string
    {
     ...
     * @param float|int|string $rate 税率（如0.1表示10%）
     * @param int $scale 保留小数位数
     * @return float|string 含税金额
     */
    public static function taxIncluded(float|int|string $amount, float|int|string $rate, int $scale = 2): float|string
    {
     ...
     * @param float|int|string $rate 税率（如0.1表示10%）
     * @param int $scale 保留小数位数
     * @return float|string 不含税金额
     */
    public static function taxExcluded(float|int|string $amount, float|int|string $rate, int $scale = 2): float|string
    {
     ...
     * @param int $years 年数
     * @param int $scale 保留小数位数
     * @return float|string 利息
     */
    public static function simpleInterest(float|int|string $principal, float|int|string $rate, int $years, int $scale = 2): float|string
    {
     ...
     * @param int $years 年数
     * @param int $scale 保留小数位数
     * @return float|string 本息合计
     */
    public static function compoundInterest(float|int|string $principal, float|int|string $rate, int $years, int $scale = 2): float|string
    {
     ...
     * @param int $scale 保留小数位数
     * @return float|string 随机数
     */
    public static function random(float|int|string $min, float|int|string $max, int $scale = 0): float|string
    {
     ...
     * @param int $scale 保留小数位数
     * @return float|string 插值结果
     */
    public static function lerp(float|int|string $start, float|int|string $end, float|int|string $t, int $scale = 10): float|string
    {
     ...
     * @param int $scale 保留小数位数
     * @return float|string 平均值
     */
    public static function average(array $numbers, int $scale = 10): float|string
    {
        if (empty($numbers)) {
            return 0;
        }
     ...
     * @param array $numbers 数值数组
     * @param int $scale 保留小数位数
     * @return float|string 中位数
     */
    public static function median(array $numbers, int $scale = 10): float|string
    {
        if (empty($numbers)) {
            return 0;
        }
     ...
     * @param array $numbers 数值数组
     * @param int $scale 保留小数位数
     * @return float|string 标准差
     */
    public static function standardDeviation(array $numbers, int $scale = 10): float|string
    {
        if (count($numbers) < 2) {
            return 0;
        }
     ...
     * @param array $numbers 数值数组
     * @param int $scale 保留小数位数
     * @return float|string 方差
     */
    public static function variance(array $numbers, int $scale = 10): float|string
    {
        if (count($numbers) < 2) {
            return 0;
        }
