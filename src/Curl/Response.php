 ...
 * @date 2026/2/23 17:33
 */

declare (strict_types=1);

namespace Cdyun\PhpTool\Curl;
    ...
    public function throwIfError(): self
    {
        if (!$this->isSuccess()) {
            $exceptionClass = match (true) {
                $this->isClientError() => ClientException::class,
                $this->isServerError() => ServerException::class,
                default => CurlException::class,
            };
