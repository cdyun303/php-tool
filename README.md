...
| 方法名 | 功能描述 | 调用示例 |
|--------|----------|----------|
| [`success()`](#messagesuccess---成功响应) | 成功响应 | `Message::success($data)` |
| [`error()`](#messageerror---错误响应) | 错误响应 | `Message::error('错误信息')` |
| [`warning()`](#messagewarning---警告响应) | 警告响应 | `Message::warning('警告信息')` |
| [`info()`](#messageinfo---信息响应) | 信息响应 | `Message::info('提示信息')` |
| [`setCode()`](#messagesetcode---设置状态码) | 设置状态码 | `Message::success()->setCode(20001)` |
| [`setMsg()`](#messagesetmsg---设置消息) | 设置消息 | `Message::success()->setMsg('操作成功')` |
| [`setData()`](#messagesetdata---设置数据) | 设置数据 | `Message::success()->setData($data)` |
| [`setPage()`](#messagesetpage---设置分页) | 设置分页 | `Message::success()->setPage($page)` |
| [`toJson()`](#messagetojson---输出json) | 输出JSON | `Message::success()->toJson()` |
...
```php
use Cdyun\PhpTool\Generate\Generate;
...
```php
use Cdyun\PhpTool\Message\Message;
...
```php
use Cdyun\PhpTool\Curl\Curl;
use Cdyun\PhpTool\Curl\Exception\CurlException;
use Cdyun\PhpTool\Curl\Exception\ClientException;
use Cdyun\PhpTool\Curl\Exception\ServerException;
...
$snake = str_snake('HelloWorld'); // 'hello_world'
// 驼峰转下划线支持数组键名
$snake = str_to_snake('helloWorld'); // 'hello_world'
$snake = str_to_snake('HelloWorld'); // 'hello_world'
...
// 下划线转驼峰支持数组键名
$camel = str_to_camel('hello_world'); // 'helloWorld'
